...
var hipstertokenApp = angular.module('hipstertokenApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'hipstertokenAppUtils', 'pascalprecht.translate', 'truncate', 'ngCacheBuster']);
