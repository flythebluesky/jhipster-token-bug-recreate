...
hipstertokenApp.controller('MainController', function ($scope) {
    });

hipstertokenApp.controller('AdminController', function ($scope) {
    });

hipstertokenApp.controller('LanguageController', function ($scope, $translate, LanguageService) {
...
hipstertokenApp.controller('MenuController', function ($scope) {
    });

hipstertokenApp.controller('LoginController', function ($scope, $location, AuthenticationSharedService) {
...
hipstertokenApp.controller('LogoutController', function ($location, AuthenticationSharedService) {
        AuthenticationSharedService.logout();
    });

hipstertokenApp.controller('SettingsController', function ($scope, Account) {
        $scope.success = null;
        $scope.error = null;
...
hipstertokenApp.controller('RegisterController', function ($scope, $translate, Register) {
        $scope.success = null;
        $scope.error = null;
...
hipstertokenApp.controller('ActivationController', function ($scope, $routeParams, Activate) {
...
hipstertokenApp.controller('PasswordController', function ($scope, Password) {
        $scope.success = null;
        $scope.error = null;
        $scope.doNotMatch = null;
...
hipstertokenApp.controller('SessionsController', function ($scope, resolvedSessions, Sessions) {
        $scope.success = null;
        $scope.error = null;
 ...
 hipstertokenApp.controller('TrackerController', ['AccessToken'], function ($scope, AccessToken) {
...
hipstertokenApp.controller('HealthController', function ($scope, HealthCheckService) {
...
hipstertokenApp.controller('ConfigurationController', function ($scope, resolvedConfiguration) {
    $scope.configuration = resolvedConfiguration;
});

hipstertokenApp.controller('MetricsController', function ($scope, MetricsService, HealthCheckService, ThreadDumpService) {
        $scope.metrics = {};
...
hipstertokenApp.controller('LogsController', function ($scope, resolvedLogs, LogsService) {
...
hipstertokenApp.controller('AuditsController', function ($scope, $translate, $filter, AuditsService) {
